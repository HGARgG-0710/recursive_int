...
int main()
{
	...
	printf("Recursive int addition test 1 (in): %ls \n", a1);
	...
	recursive_int *r4 = alloc_recursive_int(2, false);
	...
	printf("Recursive int multiplication test 1 (out): %ls", o1c1);
	...
	printf("Recursive int long long fit test 1 (in): %ls", f1);
	printf("Recursive int long long fit test 1 (out): %d", o1f1);
	printf("Recursive int long long fit test 2 (in): %ls", f2);
	printf("Recursive int long long fit test 2 (out): %d", o1f2);
